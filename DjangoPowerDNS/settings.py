...
SECRET_KEY = 'gmm$v&$c$!n9he=8wldix4(4@^iry#ax@8jc$j%3!@xmj=g$49'
...
DATABASES = {
    ...
    'powerdns': {
        ...
        'NAME': 'powerdns',
        'USER': 'powerdns',
        'PASSWORD': 'ntbRtkBRUrduyPepV9UH96s5yLcEbHHnSpNvrK6SFy4SSsmvre5WBRs7xijyQEpv',
        'HOST': 'localhost',
        'PORT': '3306',
    }
}

DATABASE_ROUTERS = ['DjangoPowerDNS.routers.DatabaseRouter']
